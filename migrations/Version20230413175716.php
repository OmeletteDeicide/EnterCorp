 ...
 */
final class Version20230413175716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE board (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, authorizedroles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_58562B4712469DE2 (category_id), INDEX IDX_58562B47A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, authorizedroles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_64C19C1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subject (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, board_id INT NOT NULL, title VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, authorizedroles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_FBCE3E7AA76ED395 (user_id), INDEX IDX_FBCE3E7AE7EC5785 (board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
